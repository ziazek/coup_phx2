defmodule CoupPhx2Web.GameLive do
  ...
  def handle_event("response", "challenge:" <> session_id, socket) do
    case Game.challenge(socket.assigns.game_pid, session_id) do
      :ok ->
        {:noreply, socket}
  ...
  def handle_event("response", "challenge_block:" <> _session_id, socket) do
    case Game.challenge_block(socket.assigns.game_pid) do
      :ok ->
        {:noreply, socket}
  ...
  def handle_event("response", "block_as_ambassador:" <> session_id, socket) do
    case Game.block(socket.assigns.game_pid, session_id, "block_as_ambassador") do
      :ok ->
        {:noreply, socket}
  ...
  def handle_event("response", "block_as_captain:" <> session_id, socket) do
    case Game.block(socket.assigns.game_pid, session_id, "block_as_captain") do
      :ok ->
        {:noreply, socket}
  ...
  def handle_event("response", "block_as_contessa:" <> session_id, socket) do
    case Game.block(socket.assigns.game_pid, session_id, "block_as_contessa") do
      :ok ->
        {:noreply, socket}
