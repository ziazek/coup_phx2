defmodule CoupEngine.SelectTargetAssassinateTest do
  ...
  describe "select_target, assassinate" do
    ...
    test "should update toast to 'Ken ASSASSINATES Zek.'", %{
      updated_state: updated_state
    } do
      latest_toast = updated_state.toast |> Enum.at(-1)
      assert latest_toast.body == "Ken ASSASSINATES Zek."
    end

    test "should update Zek available responses to Allow, Challenge, Block as Contessa",
         %{
           updated_state: updated_state
         } do
      ...
      assert zek_response2.action == "block_as_contessa"
      assert zek_response2.label == "Block as Contessa"
    end
